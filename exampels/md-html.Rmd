...
```{r kabel3, results='asis'}
knitr::kable(head(iris), format = "latex", caption = "Title of the table")

knitr::kable(head(iris), format = "latex", caption = "Title of the table", booktabs = TRUE)
```
